...
var myCountries = [];
  ...
  for(let country of countries){
    ...
    let countryData={
      countryName, population, capital, currency
    }
    myCountries.push(countryData);
  }
 ...
 // Using foreach
  ...
  //Countries with above 2cr population
  // let ppl = myCountries.filter(data=>data.population>20000000).forEach(data=>console.log(data.countryName));
